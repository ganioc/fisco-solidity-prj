...
contract HecoRuffToken is ParameterizedToken {
    ...
    event DepositEvent(address lock_ruff_addr, uint256 amount, string ruffAddr);
    event WithdrawEvent(address lock_ruff_addr, uint256 amount, address to, string txHash);
    ...
    function setLockAddr(address addr) public onlyOwner returns (bool) {
        ...
        emit LockAddrModification(_lock_ruff_addr, addr);
